            ...
            <div class="row justify-content-center">
                <div class="col-xxl-9">
                    <div class="page-title-wrapper-2 text-center">
                        <h2 class="page__title-2 mb-25">Carpentary Works</h2>
                        <div class="breadcrumb-menu-2 d-flex justify-content-center">
                            <nav aria-label="Breadcrumbs" class="breadcrumb-trail breadcrumbs">
                                <ul class="trail-items-2">
                                    ...
                                    <li class="trail-item-2 trail-end"><span>Carpentary Works</span></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="row g-50 align-items-center">
                <div class="col-lg-6 order-lg-0 order-1 p-relative">
                    <div class="df-service5__thumb">
                        <img src="{{ asset('assets/img/services/Carpentary.webp')}}" alt="img not found">
                    </div>
                ...
                <div class="col-lg-6 order-lg-1 order-0">
                    <div class="df-service5__content">
                        <div class="section__title-wrapper">
                            ...
                            <h2 class="section__title">Carpentary Works</h2>
                        </div>
                        <p class="mt-35">At Al Noor Al Huda Carpentry, we pride ourselves on delivering top-quality carpentry services tailored to meet your every need. With years of experience and a dedicated team of skilled craftsmen, we offer a comprehensive range of carpentry solutions for both residential and commercial projects. Whether you're looking to renovate your home, construct custom furniture pieces, or enhance your commercial space, we have the expertise to bring your vision to life.</p>
                            <p class=" mb-35">Our commitment to excellence extends to every aspect of our work, ensuring precision, durability, and aesthetic appeal for every project. Trust us to transform your space with unparalleled craftsmanship and personalized attention to detail.</p>
                ...
                <div class="col-lg-12">
                    <div class="df-counter__wrapper justify-content-center" id="percentage">
                        <div class="df-counter__item wow fadeInUp" data-wow-delay=".3s">
                            ...
                            <p class="df-counter__title">Quality</p>
                        </div>
                        ...
                        <div class="df-counter__item wow fadeInUp" data-wow-delay=".5s">
                            ...
                            <p class="df-counter__title">Craftsmanship</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row gy-5 wow fadeInUp" data-wow-delay=".3s">
                <div class="col-lg-5 col-md-6">
                    <div class="section__title-wrapper">
                        <h2 class="section__title">Have You Any Requirements for Carpentry Works?</h2>
                    </div>
                    ...
                    <div class="df-requirement__feature-list">
                        <ul>
                            <li>
                                ...
                                <p>Years of experience ensure superior craftsmanship.</p>
                            </li>
                            <li>
                                <span class="list-icon">
                                    <i class="icon-058-check"></i>
                                </span>
                                <p>Personalized services to match your unique needs.</p>
                            </li>
                            <li>
                                <span class="list-icon">
                                    <i class="icon-058-check"></i>
                                </span>
                                <p>Meticulous workmanship in every aspect.</p>
                            </li>
                            <li>
                                <span class="list-icon">
                                    <i class="icon-058-check"></i>
                            ...
                            <li>
                                ...
                                <p>Clear communication and timely delivery.</p>
                            </li>
                        </ul>
                    </div>
                </div>
