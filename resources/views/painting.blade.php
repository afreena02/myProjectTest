            ...
            <div class="row justify-content-center">
                <div class="col-xxl-9">
                    <div class="page-title-wrapper-2 text-center">
                        <h2 class="page__title-2 mb-25">Painting Works</h2>
                        <div class="breadcrumb-menu-2 d-flex justify-content-center">
                            <nav aria-label="Breadcrumbs" class="breadcrumb-trail breadcrumbs">
                                <ul class="trail-items-2">
                                    ...
                                    <li class="painting-works"><span>Painting Works</span></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="row g-50 align-items-center">
                <div class="col-lg-6 order-lg-0 order-1 p-relative">
                    <div class="df-service5__thumb">
                        <img src="{{ asset('assets/img/services/painting.webp')}}" alt="img not found">
                    </div>
                ...
                <div class="col-lg-6 order-lg-1 order-0">
                    <div class="df-service5__content">
                        <div class="section__title-wrapper">
                            ...
                            <h2 class="section__title">Painting Works</h2>
                        </div>
                        <p class="mt-35">At AL-NOOR AL-HUDA, we provide professional painting services to enhance the aesthetics and functionality of your spaces. With our skilled team and commitment to quality, we offer a wide range of painting solutions tailored to meet your specific needs.</p>
                            <p class=" mb-35">At AL-NOOR AL-HUDA, we prioritize customer satisfaction and attention to detail in every painting project we undertake. From color selection to final touches, we work closely with clients to ensure their vision is brought to life with precision and professionalism.
                            </p>
    ...
    <section class="df-result__area section-spacing-bottom">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="section__title-wrapper">
                        <span class="section__subtitle bg-lighter">Our painting services</span>
                        <h2 class="section__title">Elevate Your Space with Our Expert Painting Services</h2>
                    </div>
                    <div class="df-challenge__content ">
                        <p class=" mt-40">Transform your spaces with AL-NOOR AL-HUDA's professional painting services. From interior to exterior, decorative to specialty, we deliver flawless results with attention to detail and customer satisfaction guaranteed. Our painting services include:</p>
                ...
                <div class="col-lg-8">
                    <div class="df-counter__wrapper justify-content-center" id="percentage">
                        ...
                        <div class="df-counter__item wow fadeInUp" data-wow-delay=".4s">
                            ...
                            <p class="df-counter__title">Quality Assurance
                            </p>
                        </div>
                        <div class="df-counter__item wow fadeInUp" data-wow-delay=".5s">
                            ...
                            <p class="df-counter__title">Timely Completion
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row gy-5 wow fadeInUp" data-wow-delay=".3s">
                <div class="col-lg-5 col-md-6">
                    <div class="section__title-wrapper">
                        <h2 class="section__title">Have You Any Requirement for Painting Work?</h2>
                    </div>
                    ...
                    <div class="df-requirement__feature-list">
                        <ul>
                            <li>
                                ...
                                <p>Years of skilled experience</p>
                            </li>
                            <li>
                                <span class="list-icon">
                                    <i class="icon-058-check"></i>
                                </span>
                                <p>We prioritize premium materials</p>
                            </li>
                            <li>
                                <span class="list-icon">
                                    <i class="icon-058-check"></i>
                            ...
                            <li>
                                ...
                                <p>We customize solutions to match your vision and needs.</p>
                            </li>
                            <li>
                                <span class="list-icon">
                                    <i class="icon-058-check"></i>
