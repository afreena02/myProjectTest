            ...
            <div class="row justify-content-center">
                <div class="col-xxl-9">
                    <div class="page-title-wrapper-2 text-center">
                        <h2 class="page__title-2 mb-15">Plumbing</h2>
                        ...
                        <div class="product-wrapper">
                            <div class="product-single">
                                <div class="product-thumb">
                                    <a href="shop-details.html"><img src="{{ asset('assets/img/shop/plumbing-01.jpg')}}" alt="product"></a>
                                    
                                </div>
                                <div class="product-description">
                                    <h4 class="product-name">Copper Pipe And Fittings
                                    </h4>
                            ...
                            <div class="product-single">
                                <div class="product-thumb">
                                    ...
                                    <a href="shop-details.html"><img src="{{ asset('assets/img/shop/plumbing-02.jpg')}}" alt="product"></a>
                                    
                                </div>
                                <div class="product-description">
                                    <h4 class="product-name">Copper NS Fittings</h4>
                            ...
                            <div class="product-single">
                                <div class="product-thumb">
                                    <a href="shop-details.html"><img src="{{ asset('assets/img/shop/plumbing-03.jpg')}}" alt="product"></a>
                                    
                                    
                                </div>
                                <div class="product-description">
                                    <h4 class="product-name">Copper Compresion Fittings</h4>
                            ...
                            <div class="product-single">
                                <div class="product-thumb">
                                    ...
                                    <a href="shop-details.html"><img src="{{ asset('assets/img/shop/plumbing-04.jpg')}}" alt="product"></a>
                                    
                                    
                                </div>
                                <div class="product-description">
                                    <h4 class="product-name">Copper Non-Soldering Fittings</h4>
                                   
                                </div>
                            </div>
                            <div class="product-single">
                                <div class="product-thumb">
                                    <a href="shop-details.html"><img src="{{ asset('assets/img/shop/plumbing-05.jpg')}}" alt="product"></a>
                                    
                                </div>
                                <div class="product-description">
                                    <h4 class="product-name">Copper Soldering 
                                        Fittings
                                    </h4>
                            ...
                            <div class="product-single">
                                <div class="product-thumb">
                                    ...
                                    <a href="shop-details.html"><img src="{{ asset('assets/img/shop/plumbing-06.jpg')}}" alt="product"></a>
                                    
                                </div>
                                <div class="product-description">
                                    <h4 class="product-name">PVC High Pressure Pipes</h4>
                            ...
                            <div class="product-single">
                                <div class="product-thumb">
                                    <a href="shop-details.html"><img src="{{ asset('assets/img/shop/plumbing-07.jpg')}}" alt="product"></a>
                                   
                                </div>
                                <div class="product-description">
                                    <h4 class="product-name">GI, MI Fittings</h4>
                            ...
                            <div class="product-single">
                                <div class="product-thumb">
                                    ...
                                    <a href="shop-details.html"><img src="{{ asset('assets/img/shop/plumbing-08.jpg')}}" alt="product"></a>
                                    
                                </div>
                                <div class="product-description">
                                    <h4 class="product-name">Gate Valves</h4>
                            ...
                            <div class="product-single">
                                <div class="product-thumb">
                                    <a href="shop-details.html"><img src="{{ asset('assets/img/shop/plumbing-09.jpg')}}" alt="product"></a>
                                    
                                </div>
                                <div class="product-description">
                                    <h4 class="product-name">PVC Drainage Pipes</a></h4>
                            ...
                            <div class="product-single">
                                <div class="product-thumb">
                                    <a href="shop-details.html"><img src="{{ asset('assets/img/shop/plumbing-10.jpg')}}" alt="product"></a>
                                    
                                </div>
                                <div class="product-description">
                                    <h4 class="product-name">PPR Pipe Fittings</h4>
                            ...
                            <div class="product-single">
                                <div class="product-thumb">
                                    <a href="shop-details.html"><img src="{{ asset('assets/img/shop/plumbing-11.jpg')}}" alt="product"></a>
                                    
                                </div>
                                <div class="product-description">
                                    <h4 class="product-name">Rubber Type Fittings</h4>
                            ...
                            <div class="product-single">
                                <div class="product-thumb">
                                    <a href="shop-details.html"><img src="{{ asset('assets/img/shop/plumbing-12.jpg')}}" alt="product"></a>
                                    
                                </div>
                                <div class="product-description">
                                    <h4 class="product-name">Solvent Type Fittings</h4>
